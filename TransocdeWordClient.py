...
resume = {"data": 
		{
			...
			"工作经验": "2017-07 ~ 至今 中科软科技股份有限公司 互联网软件开发工程师 | 行业解决事业部 [ 10个月] 互联网/电子商务 | 5000-10000人 | 国企 工作描述: 负责项目的需求分析工作,按照需求完成基础代码模块的开发;配合测试人员完成bug的修改;编写项目文档。2015-06 ~ 2017-05 青岛松立软件科技有限公司 互联网软件开发工程师 | 金融事业部 [ 1年11个月] 互联网/电子商务 | 500-1000人 | 民营公司 工作描述: 负责项目的需求分析工作,按照需求完成基础代码模块的开发;配合测试人员完成bug的修改;编写项目文档。",
			"教育经验": "2012-09 ~ 2015-09 山东理工职业学院 大专 | 计算机信息管理",
			"个人介绍": "框架:ssm(SpringMVC、Spring、MyBatis) 数据库:MySQL、Redis 前端:JavaScript、JSP、jQuery WEB容器:Tomcat 操作系统:Linux 开发工具:SVN、Maven、Eclipse、MyEclipse,git",
			"BaseInfo": {
				"出生日期": "1994-05-23",
				"性别": "男",
				"最高学历": "大专",
...
data = {"data": json.dumps(resume["data"]), "type": "url", "url": "http://35.229.131.32/firmware/resume/templates/Hydsoft%20Candidate%20CV-Position-Name-CN.docx"}
...
#
#data = {"type": "file", "fileContent": base64Str, "data": json.dumps(resume["data"])}
#session = requests.post(url, data=data)
